# php-base - PHP Slim 4 Server library for E-Store API - Digital Commerce Platform
...
All URIs are relative to *https://api.estore.com/v1*
...
------------ | ------------- | ------------- | -------------
*AbstractDefaultApi* | **createCategory** | **POST** /categories | Create new category
*AbstractDefaultApi* | **createCustomer** | **POST** /customers | Create new customer
*AbstractDefaultApi* | **createInvoice** | **POST** /invoices | Generate invoice
*AbstractDefaultApi* | **createOrder** | **POST** /orders | Create new order
*AbstractDefaultApi* | **createProduct** | **POST** /products | Create new product
*AbstractDefaultApi* | **createReview** | **POST** /reviews | Submit review
*AbstractDefaultApi* | **getCategories** | **GET** /categories | List product categories
*AbstractDefaultApi* | **getInventory** | **GET** /stock | Get current inventory levels
*AbstractDefaultApi* | **getInvoices** | **GET** /invoices | Retrieve invoices
*AbstractDefaultApi* | **getProducts** | **GET** /products | List products
*AbstractDefaultApi* | **getReviews** | **GET** /reviews | Get product reviews
*AbstractDefaultApi* | **getSalesData** | **GET** /sales | Retrieve paginated sales records
*AbstractDefaultApi* | **listCustomers** | **GET** /customers | List customers
*AbstractDefaultApi* | **listOrders** | **GET** /orders | List orders
*AbstractDefaultApi* | **updateInventory** | **PATCH** /stock | Update inventory levels
...
* OpenAPIServer\Model\CategoryCreate
* OpenAPIServer\Model\CategoryTreeInner
* OpenAPIServer\Model\Customer
* OpenAPIServer\Model\CustomerCreate
* OpenAPIServer\Model\ErrorResponse
* OpenAPIServer\Model\ErrorResponseDetailsInner
* OpenAPIServer\Model\InventoryItem
* OpenAPIServer\Model\InventoryUpdate
* OpenAPIServer\Model\InventoryUpdateUpdatesInner
* OpenAPIServer\Model\Invoice
* OpenAPIServer\Model\InvoiceCreate
* OpenAPIServer\Model\Order
* OpenAPIServer\Model\OrderCreate
* OpenAPIServer\Model\OrderItem
* OpenAPIServer\Model\PaginatedCustomers
* OpenAPIServer\Model\PaginatedInventory
* OpenAPIServer\Model\PaginatedInvoices
* OpenAPIServer\Model\PaginatedOrders
* OpenAPIServer\Model\PaginatedProducts
* OpenAPIServer\Model\PaginatedResults
* OpenAPIServer\Model\PaginatedReviews
* OpenAPIServer\Model\PaginatedSales
* OpenAPIServer\Model\Product
* OpenAPIServer\Model\ProductCreate
* OpenAPIServer\Model\Review
* OpenAPIServer\Model\ReviewCreate
* OpenAPIServer\Model\Sale
